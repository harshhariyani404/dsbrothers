      ...
      <div className={style.about__container}>
        ...
        <div className={style.about__leaders}>
          <div className={style.leader}>
            ...
            <p>
              Founder & CEO of D.S. Brothers, the creative force and strategic mind behind the brand. With deep expertise in jewelry craftsmanship and business leadership, he has built D.S. Brothers into a trusted name known for quality, precision and timeless design.
            </p>
          </div>
        </div>
      </div>
